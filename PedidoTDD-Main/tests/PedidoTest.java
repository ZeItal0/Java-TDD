...
public class PedidoTest {
    ...
    @Test
    public void vairemoverUmItem() {
    	Pedido pedido = new Pedido();
    	pedido.adicionarItem("Produto A",2,50.0);
    	pedido.adicionarItem("Produto B",1,100.0);
    	pedido.removerUmItem("Produto B");
    	assertEquals(1, pedido.getItens().size());
    	assertEquals(100.0, pedido.getTotal(),0.001);
    }
    @Test
    public void calcularImpostoDoTotal() {
    	Pedido pedido = new Pedido();
    	pedido.adicionarItem("Produto A", 2, 50.0);
        pedido.adicionarItem("Produto B", 1, 120.0);
        
        assertEquals(39.6,pedido.imposto(),0.001);
